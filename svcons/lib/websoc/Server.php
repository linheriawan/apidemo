...
class Server{
    ...
    public function __construct(
        string $address = 'ws://127.0.0.1:8080', //the server address
        string $cert = null, // optional (for `wss`) PEM encoded public and private keys to secure the server
        string $pass = null, // optional password for the PEM certificate
    ...
    public function getServer(): mixed { return $this->server; }
    /**
    ...
    public function run(): void
    {
        ...
        while (true) {
            if (isset($this->tick)) {
                if (call_user_func($this->tick, $this) === false) { break; }
            }
    ...
    {
        $this->callbacks['validate'] = Closure::fromCallable($callback); return $this;
    }
    /**
    ...
    public function onConnect(callable $callback): static{
        $this->callbacks['connect'] = Closure::fromCallable($callback); return $this;
    }
    /**
    ...
    {
        $this->callbacks['disconnect'] = Closure::fromCallable($callback); return $this;
    }
    /**
    ...
    {
        $this->callbacks['message'] = Closure::fromCallable($callback); return $this;
    }
    /**
    ...
    {
        $this->tick = Closure::fromCallable($callback); return $this;
    }
    /**
     * connected
    ...
    protected function connected(mixed &$socket): bool
    {
        ...
        } catch (WebSocketException $e) { return false; }
    }
    /**
     * disconnectClient
     * @param resource $socket
